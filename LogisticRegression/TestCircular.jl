...
plot!(range(-1.53, stop = 1.53, length = 100), dbpos, color = "black", linewidth = 2)
plot!(range(-1.53, stop = 1.53, length = 100), dbneg, color = "black", linewidth = 2)
