...
```
    ...
    <ipython-input-71-3575597a0654> in <module>
         10 
    ...
    <ipython-input-70-5effd4085461> in conv_backward(dZ, cache)
         72 
         73     # Making sure your output shape is correct
    ---> 74     assert(dA_prev.shape == (m, n_H_prev, n_W_prev, n_C_prev))
         75 
         76     return dA_prev, dW, db


    NameError: name 'dA_prev' is not defined
...
```
    ...
    <ipython-input-73-72a0252b3f52> in <module>
          1 np.random.seed(1)
    ...
    <ipython-input-72-d1b9ce6bdffb> in create_mask_from_window(x)
         15 
